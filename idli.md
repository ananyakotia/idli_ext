...
@ayush please update the structure below. This is incorrect. 
...
\- Raw data (NSS or ASI) downloaded from the MOPSI website (@ayush insert link here)
...
For NSS: //@ayush this is wrong - it should be nss labour master file 
...
After running the master scripts, the pipeline produces: //@ayush this read me is only for nss labour so focus only on the outputs produced by nss lab code
